	...
	public void readMessage() throws IOException, ClassNotFoundException {
		...
		if (readObject != null && readObject instanceof TranObject) {
			...
			case REGISTER:// 如果用户是注册
				...
				System.out.println("readMessage, register,user:"+registerUser);
			...
			case LOGIN:
				...
				System.out.println("server readmessage,login000, user:"+loginUser.toString());
				...
				System.out.println("server readmessage,login1111,list.get(0):"+list.get(0).toString());
				if (list != null) {// 如果登录成功
					
					System.out.println("server readmessage,login, list not null");
